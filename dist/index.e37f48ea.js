...
/* ================================== */ /*                INIT                */ /* ================================== */ const init = ()=>{
    ...
    (0, _bookmarksViewJsDefault.default).addHandlerRender(loadBookmarks);
...
/* ================================== */ /*         SEARCH AND PREVIEw         */ /* ================================== */ const controlSearch = async function() {
    try {
        (0, _resultsViewJsDefault.default).renderSpinner();
        /* ======= fetch search results ====== */ await _modelJs.loadSearch((0, _searchViewJsDefault.default).getQuery());
        if (!(0, _searchViewJsDefault.default).getQuery()) return;
        /* == render results and pagination = */ controlPagination();
    } catch (err) {
        console.error(`💔${err}`);
        (0, _resultsViewJsDefault.default).renderError();
    }
};
/* ================================== */ /*             PAGINATION             */ /* ================================== */ const controlPagination = function(delta = 0) {
    _modelJs.state.search.page += delta;
    (0, _resultsViewJsDefault.default).render(_modelJs.getResultsPage(_modelJs.state.search.page));
...
/* ================================== */ /*           DISPLAY RECIPE           */ /* ================================== */ const controlRecipes = async function() {
    try {
        ...
        /* ============= get id ============= */ const id = window.location.hash.slice(1);
        if (!id) return;
        /* ========= render spinner ========= */ (0, _recipeViewJsDefault.default).renderSpinner();
        /* =========== load recipe ========== */ await _modelJs.loadRecipe(id);
...
/* ====== change serving sizes ====== */ const controlServings = function(delta) {
    _modelJs.updateServings(delta);
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
};
/* ================================== */ /*              BOOKMARKS             */ /* ================================== */ const loadBookmarks = function() {
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
};
const controlBookmarks = function() {
    if (_modelJs.state.bookmarks.has(_modelJs.state.recipe.id)) _modelJs.deleteBookmark();
    else _modelJs.addBookmark();
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
};
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","regenerator-runtime/runtime":"dXNgZ","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj"}],"49tUX":[function(require,module,exports) {
...
const loadSearch = async function(query) {
    try {
        ...
        /* ======= temp error handling ====== */ // console.error(`${err} 💔`);
        throw err;
    }
};
const loadRecipe = async function(id) {
    try {
        ...
        /* ======= temp error handling ====== */ // alert(`${err} 💔`);
        throw err;
    }
};
const constructRecipeObj = function(recipe) {
    return {
        id: recipe.id,
        title: recipe.title,
...
const updateServings = function(delta) {
...
const uploadRecipe = async function(data) {
    try {
        /* == professor code -newer methods = */ // const dataArr = [...new FormData(this._parentEl)];
        // const dataObj = Object.fromEntries(dataArr);
        // TODO - redo using the above methods
        /* ======= get data from form ======= */ const uploadData = {};
        data.forEach((i)=>{
            uploadData[i.name] = i.value;
        });
        /* ==== get ingredients in format === */ const ingredients = [];
        ...
        /* ===== construct recipe object ==== */ const newRecipe = {
...
const API_KEY = "b8061b99-4694-45af-af4e-05a7eb2797c1";
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addServingsHandler(handler) {
        this._parentEl.addEventListener("click", (e)=>{
            ...
            const delta = e.target.closest(".btn--tiny").classList.contains("btn--decrease-servings") ? -1 : 1;
            handler(delta);
        });
    }
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    addPaginationHandler(handler) {
        this._parentEl.addEventListener("click", (e)=>{
            ...
            this.delta = 0;
            target.closest("button")?.classList.contains("pagination__btn--prev") && --this.delta;
            target.closest("button")?.classList.contains("pagination__btn--next") && ++this.delta;
            handler(this.delta);
            return;
        });
    }
    _generateMarkup() {
        return `
  <button class="btn--inline pagination__btn--prev ${this._data.page === 1 ? "hidden" : ""}">
    <svg class="search__icon ">
      <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
    </svg>
    <span>Page ${this._data.page - 1}</span>
  </button>
  <button class="btn--inline pagination__btn--next ${this._data.page * 10 >= this._data.results.length ? "hidden" : ""}">
    <span>Page ${this._data.page + 1}</span>
    <svg class="search__icon">
      <use href="${0, _iconsSvgDefault.default}#icon-arrow-right"></use>
    </svg>
...
class BookmaksView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        return [
            ...this._data.values()
        ].map((bookmark)=>(0, _previewViewJsDefault.default).render(bookmark, false)).join("");
    }
}
exports.default = new BookmaksView();

},{"./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../../img/icons.svg":"loVOp","./previewView.js":"1FDQ6"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _modalBehaviour() {
        ...
        /* === close modal event listeners == */ this._overlay.addEventListener("click", this.toggleModal);
        this._btnClose.addEventListener("click", this.toggleModal);
        window.addEventListener("keydown", (ev)=>ev.key === "Escape" && this.toggleModal());
    }
...
},{"./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire3a11")
